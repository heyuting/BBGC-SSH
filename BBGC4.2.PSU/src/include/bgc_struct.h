...
typedef struct
{
	...
	//added by Y. He 14/09/06
    double* obs_soilW;	/* (m3/m3) soil water mass */
    double* obs_soilT;	/* (deg C) daily average soil temperature */
} metarr_struct;
...
typedef struct
{
	...
	double soilTobs;	/*(deg C) daily soil temperature, observation, 8cm*/
...
{
	double soilw;
	double soilWobs; //added by Y.He Oct/29/14
	double snoww;
	double canopyw;
	double leafc;
